...
public class SystemUtils {
    ...
    public static final class OsInfo {
        ...
        private final String FILE_ENCODING  = Charset.defaultCharset().name();
    ...
    private static void append(StringBuilder buffer, String caption, String value) {
        buffer.append(caption).append(org.apache.commons.lang3.StringUtils.defaultString(StringEscapeUtils.escapeJava(value), "[n/a]")).append("\n");
    }
}
